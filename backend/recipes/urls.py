...
from .views import (
    CreateDeleteFavoriteView, CreateDeleteInCartView,
    CreateDeleteSubscriptionView, IngredientsViewSet, ListSubscriptionsAPIView,
    RecipesListRetreveDestroyView, TagsViewSet, download_shoping_cart,
)
